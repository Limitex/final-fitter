...
use super::{
    AppPaths, ENV_PREFIX, default_lock_file, default_log_file, default_pid_file,
    default_socket_path, default_tcp_addr, default_workdir,
};
...
mod tests {
    use super::*;
    use crate::config::DEFAULT_TCP_ADDR;
